...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("AlternateSuppliersListListReport journey");
        ...
        opaTest("Start application", function (Given, When, Then) {
            ...
            Then.onTheAlternateSuppliersListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheAlternateSuppliersListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheAlternateSuppliersListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheAlternateSuppliersListGenerated.onTable(defaultTableId).iCheckRows();
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheAlternateSuppliersListGenerated.onFilterBar().iExecuteSearch();
            Then.onTheAlternateSuppliersListGenerated.onTable(defaultTableId).iCheckRows();
            When.onTheAlternateSuppliersListGenerated.onTable(defaultTableId).iPressRow(0);
